...
const DOCUMENTS: ResourceDoc[] = [
  ...
  },
  {
    ...
    icon: Scroll,
    color: "#a855f7",
    description: "Architecture, philosophy, reward mechanics, content structure, engagement systems, and implementation decisions for the world's first AI-guided infrastructure education platform. v2.1 adds Competitive Landscape Analysis and Node 018 Feedback Response. v2.0 added Engagement Layer, Appraisal System, and Inspector Feedback Response.",
    sections: ["Design Philosophy", "Content Architecture", "Player Progression", "FITS System", "MPNC Fleet", "Ability Scores", "Dearden Field", "DAVID AI", "Visual & Audio Design", "Engagement Layer", "Platform Architecture", "Design Decisions Log", "Appraisal System", "Inspector Feedback Response", "Competitive Landscape", "Node 018 Response"],
    status: "ACTIVE",
