          ...
          {activeTab === "laws" && (
            <motion.div key="laws" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-8">
              <div className="text-center space-y-3">
                ...
                <h2 className="font-heading text-3xl md:text-4xl text-gold-gradient">4 Laws of iAAi</h2>
                <p className="text-muted-foreground text-sm max-w-xl mx-auto">
            ...
            <motion.div key="walkby" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-8">
              ...
              <div className="bg-card border border-border/50 rounded-xl overflow-hidden max-w-2xl mx-auto">
                ...
                <div className="p-4 text-center">
                  <h4 className="font-heading text-gold text-sm">The Walkby iCard</h4>
                  <p className="text-xs text-muted-foreground">TP-013 — 4-Level Control Hierarchy — iAAi Archive</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {activeTab === "laws" && (
            <motion.div key="laws-icard" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mt-8">
              <div className="bg-card border border-border/50 rounded-xl overflow-hidden max-w-2xl mx-auto">
                ...
                />
                <div className="p-4 text-center">
                  <h4 className="font-heading text-gold text-sm">4 Laws of iAAi — iCard</h4>
                  <p className="text-xs text-muted-foreground">Asimov 3 becomes 4 — The Missing Law — iAAi Archive</p>
                </div>
              </div>
              ...
              <div className="bg-card border border-border/50 rounded-xl overflow-hidden max-w-2xl mx-auto mt-6">
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">The 4-point consciousness model — iAAi Archive</p>
                </div>
              </div>
            </motion.div>
          )}
