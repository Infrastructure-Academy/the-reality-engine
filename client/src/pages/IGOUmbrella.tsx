    ...
    <div className="min-h-screen" style={{ background: "linear-gradient(180deg, #050510 0%, #0a1628 10%, #0a1628 90%, #050510 100%)" }}>
      ...
      <div className="pt-20 px-4 max-w-7xl mx-auto pb-24">
        ...
        <section className={`text-center mb-20 transition-all duration-1000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="mb-6">
            <h1 className="mb-3 font-bold" style={{ fontSize: "clamp(2.5rem, 8vw, 5rem)", color: "#ffd700", textShadow: "0 0 60px rgba(255,215,0,0.3), 0 0 120px rgba(255,215,0,0.1)", letterSpacing: "0.05em" }}>
              <BrandI />GO
            </h1>
        ...
        {/* Why Video? — Cross-Generational Case */}
        <section className={`mb-12 transition-all duration-1000 delay-600 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="max-w-2xl mx-auto">
            <ImageLightbox
              src={CDN.whyVideo}
              alt="Why Video? The Cross-Generational Case — Evidence-Based Media Format Selection"
              className="w-full rounded-lg border border-amber-400/20 hover:border-amber-400/40 transition-colors"
            />
          </div>
        </section>
