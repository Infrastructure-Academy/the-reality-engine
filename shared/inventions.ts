...
export const INVENTIONS: Record<number, Invention[]> = {
  ...
  12: [
    ...
    { name: "Torus Network", description: "A network topology where every node connects in a continuous loop with no dead ends. The torus metaphor describes a civilisation where every human node both gives and receives.", date: "2026+ CE", significance: "paradigm-shift" },
    { name: "Consciousness Map", description: "Theoretical frameworks mapping the structure and flow of awareness itself. From Integrated Information Theory to Global Workspace Theory — consciousness as the ultimate infrastructure.", date: "2026+ CE", significance: "paradigm-shift" },
    ...
    { name: "Ethical Framework", description: "Structured systems for making moral decisions about technology deployment. As infrastructure becomes planetary, ethical frameworks become infrastructure themselves — governing what we build and why.", date: "2026+ CE", significance: "foundational" },
    { name: "Planetary Node", description: "The concept of Earth itself as a single interconnected infrastructure node in a potential interplanetary network. Every human, sensor, and system contributing to planetary awareness.", date: "2026+ CE", significance: "paradigm-shift" },
    ...
    { name: "Empathy Engine", description: "AI systems designed to understand and respond to human emotional states. Empathy engines could transform education, healthcare, and conflict resolution — technology that feels.", date: "2026+ CE", significance: "revolutionary" },
    { name: "Human Node", description: "Every person as a conscious node in the civilisational network — simultaneously receiver, processor, and transmitter of knowledge, culture, and purpose. You are the infrastructure.", date: "2026+ CE", significance: "paradigm-shift" },
  ],
};
